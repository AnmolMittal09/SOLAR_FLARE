...
const Brands: React.FC = () => {
  return (
    <div className="pt-48 pb-32 bg-slate-50/50">
      <SEO 
        title="Hardware Partners & Tier-1 Brands" 
        description={`DRG Power partners with global leaders like ${PARTNER_BRAND}, Waree, and Jakson to ensure high-performance solar components.`}
      />
      <div className="container mx-auto px-6">
        <div className="text-center mb-32">
          <span className="text-[#BE1E2D] font-black uppercase tracking-[0.6em] text-[10px] mb-8 block">Quality Ecosystem</span>
          <h1 className="text-6xl md:text-[9rem] font-black tracking-tighter uppercase italic leading-none">ELITE <span className="text-gradient">HARDWARE.</span></h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
          {BRANDS.map((brand, i) => (
            <div key={i} className="bg-white p-16 rounded-[3rem] shadow-xl border border-slate-100 hover:border-[#BE1E2D]/20 transition-all group">
              <div className="mb-10 flex items-center justify-between">
                <span className="bg-slate-50 text-[10px] font-black uppercase tracking-widest px-5 py-2 rounded-full text-slate-400 group-hover:bg-[#BE1E2D]/5 group-hover:text-[#BE1E2D] transition-all">
                  {brand.role}
                </span>
              ...
              <h3 className="text-4xl font-black text-slate-900 tracking-tighter uppercase mb-6">{brand.name}</h3>
              ...
              <div className="pt-8 border-t border-slate-50 flex items-center gap-4">
                <span className="text-[10px] font-black uppercase tracking-widest text-slate-300 italic">Certified Tier-1 Vendor</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-48 grid lg:grid-cols-2 gap-20 items-center">
           <div className="space-y-12">
              <h2 className="text-5xl font-black uppercase tracking-tighter leading-none italic">The DRG <span className="text-[#BE1E2D]">Standard.</span></h2>
              <div className="space-y-8">
                 {[
                   ...
                   <div key={i} className="flex gap-8 group">
                      <div className="w-16 h-16 shrink-0 bg-white rounded-2xl flex items-center justify-center text-3xl shadow-xl group-hover:bg-[#BE1E2D] group-hover:text-white transition-all">
                        {i === 0 ? "📈" : i === 1 ? "⚡" : "🏗️"}
                      </div>
                      <div>
           ...
           <div className="relative">
              ...
              <div className="relative bg-slate-900 p-20 rounded-[4rem] border border-white/5 shadow-3xl text-white">
